...
//                }
//        );
//        this.root.get("employee").get("organization").get("name").alias("organizationName");
...
//                    Selection<T> selection = getSelection(strs);
//                    selections.add(selection);
//                }
//        );
////        boolean objectPath = this.root.get("employee").get("organization").get("name").equals(this.root.join("employee",JoinType.LEFT).join("organization",JoinType.LEFT).get("id"));
//
//        this.cq.multiselect(selections);
//    }
//
//    /**
//     * 设置排序
...
//            case 1:
//                return this.root.get(strings[0]).alias(getAlias(strings));
//            case 2:
